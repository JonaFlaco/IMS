...
foreach($data as $itm){
    ...
    <div class="d-flex align-items-start mt-1 mb-1">
        ...
        <div class="w-100 overflow-hidden">
            <span class="float-end"><?= \App\Helpers\DateHelper::humanify( strtotime($itm->created_date)); ?></span>
            ...
            <span class="badge bg-<?= $itm->is_used == true ? "success" : "danger"; ?>"><?= $itm->is_used == true ? "Used" : "Not Used"; ?></span>
        </div>
    </div>
