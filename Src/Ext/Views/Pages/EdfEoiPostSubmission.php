                ...
                <div class="row">
                    <div class="col-12">
                        <div class="text-center">                             
                            ...
                            <p class="w-75 mb-2 mx-auto">Su solicitud ha sido enviada. Le hemos enviado los detalles de la solicitud a la dirección de correo electrónico proporcionada.</p>
                        </div>
                    </div> <!-- end col -->
                </div> <!-- end row -->
            </div>
