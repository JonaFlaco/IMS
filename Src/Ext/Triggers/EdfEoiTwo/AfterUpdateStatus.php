...
class AfterUpdateStatus extends BaseTrigger
{
    ...
    {
        $edfEoi = $this->coreModel->nodeModel("edf_eoi_two")->fields(['represent_name','email'])->id($id)->loadFirstOrFail();
    ...
    function sendApprovedEmailNotification($edfEoi)
    {
        ...
        (new EmailService($edfEoi->email, "¡El estado de su solicitud ha cambiado!", $body))
