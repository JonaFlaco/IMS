...
<div class="row">
    <div class="col-lg-3">
        <div class="card widget-flat">
            <div class="card-body">
                <div class="float-end">
                    <i class=" mdi mdi-link-variant widget-icon"></i>
                </div>
                <h5 class="text-muted font-weight-normal mt-0" title="Number of Orders">Requests - Last 24 Hours</h5>
    ...
    <div class="card widget-flat">
            <div class="card-body">
                ...
                <h5 class="text-muted font-weight-normal mt-0" title="Number of Orders">Requests - Last 7 Days</h5>
    ...
    <div class="col-lg-3">
        <div class="card widget-flat">
            <div class="card-body">
                ...
                <h5 class="text-muted font-weight-normal mt-0" title="Number of Orders">Requests - Last 1 Month</h5>
