...
class CtypeExportQuestionnaireTemplate extends Controller {
    ...
    public function index($id, $params = []){
        ...
        $ctype = $this->coreModel->nodeModel("ctypes")
                                ...
                                ->loadFirstOrDefault();
        (new \App\Core\BgTask())
        ->setName("Export $ctype->name questionnaire template")
        ->setActionName("CtypeExportQuestionnaireTemplate")
